...
object DrovaMockData {
    ...
    val sampleAddresses = listOf(
        ...
        SavedAddress(
            ...
            labelAr = "العمل",
            labelEn = "Work",
            districtAr = "التجمع الخامس، القاهرة الجديدة",
            detailedAddressAr = "مبنى الأعمال 3B، شارع التسعين الشمالي، الدور 2",
            isDefault = false
        ),
        SavedAddress(
            id = "addr_3",
    ...
    val sampleRestaurants = listOf(
        ...
        Restaurant(
            ...
            deliveryFeeEgp = 25.0,
            isOpen = true,
            addressAr = "شارع التسعين الشمالي، التجمع الخامس",
        ...
        Restaurant(
            id = "rest_4",
            nameAr = "بيتزا أند كابري الزمالك",
        ...
        Restaurant(
            ...
            deliveryFeeEgp = 30.0,
            isOpen = true,
            addressAr = "مجمع المطاعم، التسعين الجنوبي، التجمع الخامس",
            commissionRatePercent = 10.0,
            activeSubscriptionTier = "DROVA Pro Partner",
            menu = listOf(
        ...
        Restaurant(
            ...
            deliveryFeeEgp = 20.0,
            isOpen = true,
            addressAr = "شارع النصر، المعادي، القاهرة",
            commissionRatePercent = 12.0,
            activeSubscriptionTier = "DROVA Pro Partner",
            menu = listOf(
    ...
    val sampleOrders = listOf(
        Order(
            ...
            deliveryAddressAr = "برج زهرة المعادي، كورنيش النيل، الدور 7",
            restaurantId = "rest_1",
        ...
        Order(
            ...
            deliveryAddressAr = "ميدان الحرية، المعادي، عمارة 8 شقة 3",
            restaurantId = "rest_1",
            restaurantNameAr = "شاورما الريم المعادي",
            restaurantAddressAr = "شارع 9، المعادي، القاهرة",
            captainId = null,
        ...
        Order(
            ...
            deliveryAddressAr = "شارع النادي، دجلة المعادي، فيلا 12",
            restaurantId = "rest_1",
            restaurantNameAr = "شاورما الريم المعادي",
            restaurantAddressAr = "شارع 9، المعادي، القاهرة",
            captainId = "cap_1",
        ...
        Order(
            ...
            deliveryAddressAr = "شارع 105، حدائق المعادي، عمارة الأمل",
            restaurantId = "rest_1",
            restaurantNameAr = "شاورما الريم المعادي",
            restaurantAddressAr = "شارع 9، المعادي، القاهرة",
            captainId = "cap_1",
        ...
        Order(
            ...
            deliveryAddressAr = "عمارة 14، شارع النصر، المعادي، القاهرة",
            restaurantId = "rest_1",
            restaurantNameAr = "شاورما الريم المعادي",
            restaurantAddressAr = "شارع 9، المعادي، القاهرة",
            captainId = "cap_1",
        ...
        Order(
            ...
            deliveryAddressAr = "شارع اللاسلكي، المعادي الجديدة",
            restaurantId = "rest_1",
            restaurantNameAr = "شاورما الريم المعادي",
            restaurantAddressAr = "شارع 9، المعادي، القاهرة",
            captainId = "cap_1",
        ...
        Order(
            ...
            deliveryAddressAr = "زهراء المعادي، شطر 7، عمارة 21",
            restaurantId = "rest_1",
            restaurantNameAr = "شاورما الريم المعادي",
            restaurantAddressAr = "شارع 9، المعادي، القاهرة",
            captainId = "cap_1",
        ...
        Order(
            ...
            deliveryAddressAr = "عمارة 14، شارع النصر، المعادي، القاهرة",
            restaurantId = "rest_2",
            restaurantNameAr = "برجر بوكس التجمع",
            restaurantAddressAr = "شارع التسعين الشمالي، التجمع الخامس",
            captainId = null,
            captainName = null,
            captainPhone = null,
            items = listOf(
        ...
        Order(
            ...
            deliveryAddressAr = "عمارة 14، شارع النصر، المعادي، القاهرة",
            restaurantId = "rest_4",
            restaurantNameAr = "بيتزا أند كابري الزمالك",
            restaurantAddressAr = "شارع 26 يوليو، الزمالك، القاهرة",
            captainId = "cap_1",
            captainName = "محمود عادل",
            captainPhone = "+201198765432",
            items = listOf(
        ...
        Order(
            ...
            restaurantAddressAr = "شارع النصر، المعادي، القاهرة",
            captainId = "cap_1",
            captainName = "محمود عادل",
            captainPhone = "+201198765432",
            items = listOf(
    ...
    val sampleDeliveryTasks = listOf(
        DeliveryTask(
            ...
            restaurantId = "rest_3",
            restaurantNameAr = "كشري التحرير الأصلي",
            restaurantNameEn = "Koshary El Tahrir",
            restaurantAddressAr = "شارع التحرير، الدقي، الجيزة",
            restaurantPhone = "+201099887766",
            pickupDistanceKm = 1.2,
            customerName = "كريم السيد",
            customerPhone = "+201012345678",
            customerAddressAr = "برج الأطباء، شارع الدقي، الجيزة",
        ...
        DeliveryTask(
            ...
            customerPhone = "+201122334455",
            customerAddressAr = "شارع الشويفات، التجمع الخامس، فيلا 22",
        ...
        DeliveryTask(
            ...
            customerAddressAr = "شارع دجلة 206، المعادي، عمارة 5",
    ...
    val sampleCompletedTasks = listOf(
        DeliveryTask(
            ...
            customerName = "محمد سامي",
            customerPhone = "+201122334455",
            customerAddressAr = "شارع اللاسلكي، المعادي الجديدة، برج النيل 3",
        ...
        DeliveryTask(
            ...
            customerName = "هاني خليل",
            customerPhone = "+201066778899",
            customerAddressAr = "زهراء المعادي، شطر 7، عمارة 21، شقة 5",
        ...
        DeliveryTask(
            ...
            customerName = "أحمد مصطفى",
            customerPhone = "+201012345678",
            customerAddressAr = "عمارة 14، شارع النصر، المعادي، القاهرة",
    ...
    val sampleCaptainNotifications = listOf(
        CaptainNotification(
            ...
            messageAr = "مطعم كشري التحرير بالدقي - العائد المتوقع 42.50 ج.م",
